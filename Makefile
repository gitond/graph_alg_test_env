...
all: $(MAINDEP) $(TESTDEP)
	...
	$(CC) main.o command_parser.o maincomms.o tcomms.o gcomms.o commands.o module_loader.o vertex.o graph.o rand_mat_gen.o visualisation.o graph_file_operations.o -o $(MAINEX) $(CFLAGS)

	# tests
	$(CC) -c tests/command_parsing.cpp
	$(CC) command_parsing.o command_parser.o maincomms.o tcomms.o gcomms.o commands.o module_loader.o vertex.o graph.o rand_mat_gen.o visualisation.o graph_file_operations.o -o $(CPEXEC) $(CFLAGS)
	$(CC) -c tests/module_loading.cpp
	$(CC) module_loading.o command_parser.o maincomms.o tcomms.o gcomms.o commands.o module_loader.o vertex.o graph.o rand_mat_gen.o visualisation.o graph_file_operations.o -o $(MLEXEC) $(CFLAGS)
...
newtest: $(MAINDEP)
	...
	$(CC) -c app/modules/graphs/visualisation.cpp
	$(CC) -c app/modules/graphs/graph_file_operations.cpp
	$(CC) main.o command_parser.o maincomms.o tcomms.o gcomms.o commands.o module_loader.o vertex.o graph.o rand_mat_gen.o visualisation.o graph_file_operations.o -o testbuilds/newest $(CFLAGS)
