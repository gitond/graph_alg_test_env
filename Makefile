...
all: $(MAINDEP) $(TESTDEP)
	...
	$(CC) main.o command_parser.o maincomms.o tcomms.o gcomms.o commands.o module_loader.o vertex.o graph.o rand_mat_gen.o visualisation.o graph_file_operations.o dijkstra.o -o tb $(CFLAGS)
